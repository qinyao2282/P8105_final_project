...
```{r}
library(gsheet)
airquality_2015 = gsheet2tbl('https://docs.google.com/spreadsheets/d/1CRJzMI0QbqU34BZZQ1bg3BnZPM_oUfVUCVPOo4AnoB0/edit?usp=sharing') %>% 
  janitor::clean_names() %>%
  select(state, pm2_5) %>%   
  group_by(state) %>% 
...
>>>>>>> c475301a166973784837b08d7ffe823d8bc773ca
```{r}
